...
path_to_dataset = '/GestureNP'   #Path to the directory of dataset generated by adeat2np.py
split_ratio = 0.9   # 90% samples for training

N = 10                  # Frame number of single sample
split_num = 4          # Split one sample into samples
H = 128     
W = 128
t_start = 0.0e6        # start time 
t_tot = t_start+1.3e6*split_num  # compute total time of spike train

train_filename = './dvs-gesture-10-X/train/{}.pt'
test_filename = './dvs-gesture-10-X/test/{}.pt'
